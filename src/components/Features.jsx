const Features = () => {
  return (
    <div className="bg-white p-4 shadow-lg border border-e6 text-00 rounded-md font-medium">
      <div>
        <p className="text-20 mb-6">Why Travel with us?</p>
        <ul className="list-disc list-inside text-14 flex flex-col gap-2">
